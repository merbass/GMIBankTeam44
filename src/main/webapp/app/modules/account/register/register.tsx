...
import { Translate, translate, logInfo } from 'react-jhipster';
...
export const RegisterPage = (props: IRegisterProps) => {
  ...
  const handleValidSubmit =  (event, values) => {
    props.handleRegister(values.ssn,values.firstname,values.lastname,values.address,values.mobilephone,values.username, values.email, values.firstPassword, props.currentLocale);
      ...
      <Row className="justify-content-center">
        <Col md="8">
          ...
          <AvField
              ...
              validate={{
                required: { value: true, errorMessage: translate('Your SSN is required') },
                pattern: {
